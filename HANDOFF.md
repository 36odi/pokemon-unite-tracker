...
> 最終更新: 2026-07-17 / アプリバージョン: v5.32 / 公開SW: v53 / ローカルSW: v53

## 0. 現在のスナップショット（2026-07-17 15:21 JST）

- 公開 `main` は v5.32 / SW v53。2026-07-17にデータ更新、PWAアイコン同梱化、ユーザー向け更新履歴を反映。
...
- 検証済み: `node tests/logic.test.js` 82/82 PASS、レシオ1689/1689一致、ステータス96/96体差分ゼロ、変換器の構造ドリフト・オラクル不一致ともに0。
- 対戦用ロスターは95体。ラボは96体（ストライクを含む）、スキル1,761行、メダル257枚、もちもの34個、メダル色11種。
