...
> 最終更新: 2026-08-24 / アプリバージョン: v5.40 / 公開SW: v63 / ローカルSW: v63
...
Service Worker。ローカル・公開のキャッシュ名は `unite-tracker-v63`。`lab_data.js`、`js/constants.js`、`js/utils.js`、`js/lab-core.js`、PWA用192px・512pxアイコンを含むアプリシェルをキャッシュする。
